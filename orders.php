...
<div class="form-group">
          ...
          <div class="col-sm-9">     
           <input name="oid" type="text" readonly class="form-control" id="oid" placeholder="Order ID"value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_id']; ?>" > 
 </div>
        </div>
      <div class="form-group">
      ...
      <div class="form-group">
          <label for="sid" class="col-sm-3 control-label">Staff Name</label>
          <div class="col-sm-9">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a176925_pt2");
        $stmt->execute();
      ...
      <div class="form-group">
          <label for="cid" class="col-sm-3 control-label">Customer Name</label>
          <div class="col-sm-9">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_customers_a176925_pt2");
        $stmt->execute();
        $result = $stmt->fetchAll();
      }
      catch(PDOException $e){
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a176925_pt3, tbl_staffs_a176925_pt2, tbl_customers_a176925_pt2 WHERE ";
        $sql = $sql."tbl_orders_a176925_pt3.fld_staff_id = tbl_staffs_a176925_pt2.fld_staff_id and ";
        $sql = $sql."tbl_orders_a176925_pt3.fld_customer_id = tbl_customers_a176925_pt2.fld_customer_id LIMIT $start_from, $per_page";
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_orders_a176925_pt3, tbl_staffs_a176925_pt2, tbl_customers_a176925_pt2 WHERE tbl_orders_a176925_pt3.fld_staff_id = tbl_staffs_a176925_pt2.fld_staff_id and tbl_orders_a176925_pt3.fld_customer_id = tbl_customers_a176925_pt2.fld_customer_id");
            $stmt->execute();
            $result = $stmt->fetchAll();
