...
<meta charset="utf-8">
  ...
  <title>Hashotidy: Customers</title>
  <!-- Bootstrap -->
    ...
    <form action="customers.php" method="post" class="form-horizontal">
     ...
     <input name="name" type="text"class="form-control" id="name" placeholder="Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_name']; ?>" required> 
        ...
        <div class="form-group">
          ...
          <div class="radio">
            <label>
     <input name="membership" type="radio" id="membership" value="YES" <?php if(isset($_GET['edit'])) if($editrow['fld_membership']=="YES") echo "checked"; ?> required> YES
      </label>
          </div>
          <div class="radio">
            <label>
      <input name="membership" type="radio" id="membership" value="NO" <?php if(isset($_GET['edit'])) if($editrow['fld_membership']=="NO") echo "checked"; ?>> NO 
       </label>
            </div>
          </div>
        </div>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_customers_a176925_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
      ...
      <tr>
        ...
        <td><?php echo $readrow['fld_membership']; ?></td>
        <td>
