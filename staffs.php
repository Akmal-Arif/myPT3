    ...
    <form action="staffs.php"method="post">
      ...
      <input name="name" type="text" class="form-control" id="name" placeholder="Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_name']; ?>" required>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
           <input name="age" type="number" class="form-control" id="age" placeholder="Age" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_age']; ?>" min="0" step="1" required>
        </div>
        </div>
      <div class="form-group">
          <label for="qualification" class="col-sm-3 control-label">Qualification</label>
          <div class="col-sm-9">
      <input name="qualification" type="text" class="form-control" id="qualification" placeholder="Qualification" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_qualification']; ?>" required>
      </div>
        </div>
        <div class="form-group">
              <label for="inputEmail" class="col-sm-3 control-label">Email Address</label>
              <div class="col-sm-9">
                <input name="email" type="text" class="form-control" id="inputEmail" pattern="[A-Za-z0-9._%+-]+@[gmail]+\.[com]{3}$" placeholder="Please insert your email" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_email']; ?>" required>
              </div>
            </div>
            <div class="form-group">
              ...
              <label for="level" class="col-sm-3 control-label">Level</label>
                <div class="col-sm-9">
                  <select class="form-control" name="level" required>
                    <option value="staff" <?php echo(isset($_GET['edit']) && $editrow['fld_user_level'] == 'staff' ? 'selected' : ''); ?>>
                      Staff
                    </option>
                    <option value="admin" <?php echo(isset($_GET['edit']) && $editrow['fld_user_level'] == 'admin' ? 'selected' : ''); ?>>
                      Administrator
                    </option>
                  </select>
                </div>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a176925_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
      ...
      <tr>
        ...
        <td><?php echo $readrow['fld_qualification']; ?></td>
        <td>
